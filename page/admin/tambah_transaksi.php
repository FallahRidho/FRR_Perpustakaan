...
<head>
    ...
    <title>Tambah Transaksi Peminjaman Admin</title>
...
$tampilNamaAnggota = $conn->query("SELECT * FROM tb_anggota ORDER BY id_anggota") or die(mysqli_error($conn));
...
if(isset($_POST['tambah'])) {
    ...
    while($data = $sql->fetch_assoc()) {
        ...
        if($sisa == 0) {
            ...
            $conn->query("INSERT INTO tb_transaksi VALUES(null, '$id_transaksi', '$id_anggota', '$nis_anggota', '$tgl_pinjam', '$tgl_kembali', 'pinjam')") or die(mysqli_error($conn));
...
<div class="card-header mb-5">
    ...
    <div class="form-group">
        ...
        <select name="buku" id="nama_buku" class="form-control">
            ...
            echo "<option value='$pecahBuku[id_bk].$pecahBuku[judul_bk]'>$pecahBuku[id_bk] / $pecahBuku[judul_bk]</option>";
    ...
    <div class="form-group">
        ...
        <select name="nama" id="nama_anggota" class="form-control">
            ...
            echo "<option value='$pecahAnggota[id_anggota].$pecahAnggota[nama_anggota]'>$pecahAnggota[id_anggota] / $pecahAnggota[nama_anggota]</option>";
            }
            ?>
        </select>
    </div>
