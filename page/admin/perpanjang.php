...
if($lambat > 3) {
	...
	if($sql) {
		echo "<script>alert('Perpanjang jangka waktu buku berhasil.');window.location='transaksi.php';</script>";
	} else {
		echo "<script>alert('Perpanjang gagal.');window.location='transaksi.php';</script>";
	}
}
