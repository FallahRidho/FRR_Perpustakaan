...
?>
 <div class="container-fluid">
                ...
                <div class="float-right">
						Cetak data : <a href="pengunjung_pdf.php" target="_blank" class="btn btn-primary" ><i class="fa fa-file-pdf-o">Print </i> </a>
			            Export data : <a href="pengunjung_excel.php" target="_blank" class="btn btn-success" ><i class="fa fa-file-pdf-o">excel</i> </a>
                        </div>
			</div>
