...
<h1 class="mt-4">Data Transaksi Selesai</h1></center>
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <table class="table table-striped table-hover dtabel">
            ...
            Cetak data : <a href="transaksikembali_pdf.php" target="_blank" class="btn btn-primary" ><i class="fa fa-file-pdf-o">Print</i> </a>
			Export data : <a href="transaksikembali_excel.php" target="_blank" class="btn btn-success" ><i class="fa fa-file-pdf-o">excel</i> </a>	
						</div>	
			</div>
